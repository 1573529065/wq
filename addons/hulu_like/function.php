...
function auth() {
    ...
    if ($my['upid'] == "1") {
        //msg("سىز قارا تىزىملىككە كىرگۈزىۋىتىلگەن!","","error");
        echo"<script>alert('سىز قارا تىزىملىككە كىرگۈزىۋىتىلگەن');</script>";
...
function getactivetype($activetype) {
    if ($activetype == '1') {
        return"شەخسى ئۇيۇشتۇرغان";
    } elseif ($activetype == '2') {
        return"سودىگەرلەر ئۇيۇشتۇرغان";
    } elseif ($activetype == '3') {
        return"كۇلۇپ ئۇيۇشتۇرغان";
    }
}
...
function getordertype($ordertype) {
    ...
    if ($ordertype == "1") {
        return"ئالتۇن ئەزا بولۇش";
    } elseif ($ordertype == "2") {
        return"پائالىيەتكە قاتنىشىش";
    } elseif ($ordertype == "3") {
        return"تەڭگە قاچىلاش";
    } elseif ($ordertype == "4") {
        return"سوۋغات بېرىش";
    } elseif ($ordertype == "5") {
        return"تارتۇقلاش";
    } elseif ($ordertype == "6") {
        return"چەمبىرەكتە تارتۇقلاش";
    }
}
...
function getusertag($uniacid, $openid) {
    ...
    if ($user['upid'] == '4') {
        $tag1 = "<div class='user_list_b_4_p'>ئالتۇن ئەزا</div>";
    }
    if ($user['realname'] == '2') {
        $tag2 = "<div class='user_list_b_4_p'>ھەقىقىي نام</div>";
    }
...
function getmemberinfo($uniacid, $openid) {
    ...
    return $member_birthday . 'ياش | ' . $member_height . 'CM | ' . $member_weight . 'KG';
}
...
function purposedata() {
    $purpose = array(
        array('purpose_id' => '1', 'purpose_name' => 'دوستلىشىش'),
        array('purpose_id' => '2', 'purpose_name' => 'تويلىشىش'),
        array('purpose_id' => '3', 'purpose_name' => 'مۇھەببەتلىشىش'),
        array('purpose_id' => '4', 'purpose_name' => 'ئۆگۈنۈش'),
        array('purpose_id' => '5', 'purpose_name' => 'باشقا'),
    );
    return $purpose;
}
...
function feelingdata() {
    $feeling = array(
        array('feeling_id' => '1', 'feeling_name' => 'بويتاق'),
        array('feeling_id' => '2', 'feeling_name' => 'نىشان بار'),
        array('feeling_id' => '3', 'feeling_name' => 'مۇھەببەتلىشىۋاتقان'),
    );
    return $feeling;
}
...
function marrydata() {
    $marry = array(
        array('marry_id' => '1', 'marry_name' => 'توي قىلمىغان'),
        array('marry_id' => '2', 'marry_name' => 'توي قىلغان'),
        array('marry_id' => '3', 'marry_name' => 'ئاجراشقان'),
        array('marry_id' => '4', 'marry_name' => 'تەنھا'),
    );
    return $marry;
}

//交友目的
function purposedata111() {
    $purpose = array(
        array('purpose_id' => '1', 'purpose_name' => 'دوستلىشىش'),
        array('purpose_id' => '2', 'purpose_name' => 'تويلىشىش'),
        array('purpose_id' => '3', 'purpose_name' => 'مۇھەببەتلىشىش'),
...
function salarydata() {
    $salary = array(
        array('salary_id' => '1', 'salary_name' => 'مائاشى چەكلەنمەيدۇ'),
        array('salary_id' => '2', 'salary_name' => '1000يۈەندىن تۆۋەن'),
        array('salary_id' => '3', 'salary_name' => '1000-2000يۈەنگىچە'),
        array('salary_id' => '4', 'salary_name' => '2000-3000يۈەنگىچە'),
        array('salary_id' => '5', 'salary_name' => '3000-4000يۈەن'),
        array('salary_id' => '6', 'salary_name' => '4000-5000يۈەنگىچە'),
        array('salary_id' => '7', 'salary_name' => '5000-6000يۈەنگىچە'),
        array('salary_id' => '8', 'salary_name' => '6000-7000يۈەنگىچە'),
        array('salary_id' => '9', 'salary_name' => '7000-8000يۈەنگىچە'),
        array('salary_id' => '10', 'salary_name' => '8000-9000يۈەنگىچە'),
        array('salary_id' => '11', 'salary_name' => '9000-1000يۈەنگىچە'),
        array('salary_id' => '12', 'salary_name' => '1-1.5 تۈمەنگىچە'),
        array('salary_id' => '13', 'salary_name' => '1.5-2 تۈمەنگىچە'),
        array('salary_id' => '14', 'salary_name' => '2 تۈمەندىن يۇقۇرى'),
    );
    return $salary;
}
function salarydata111() {
    $salary = array(
        array('salary_id' => '1', 'salary_name' => 'مائاشى چەكلەنمەيدۇ'),
        array('salary_id' => '2', 'salary_name' => '1000يۈەندىن تۆۋەن'),
        array('salary_id' => '3', 'salary_name' => '1000-2000يۈەنگىچە'),
...
function educationdata() {
    $education = array(
        array('education_id' => '1', 'education_name' => 'مەدەنىيەت سەۋىيسى چەكلەنمەيدۇ'),
        array('education_id' => '2', 'education_name' => 'دوكتور ئاشتى'),
        array('education_id' => '3', 'education_name' => 'دوكتور'),
        array('education_id' => '4', 'education_name' => 'ماگىستىر'),
        array('education_id' => '5', 'education_name' => 'ئاسپىرانت'),
        array('education_id' => '6', 'education_name' => 'تولۇق كۇرۇس'),
        array('education_id' => '7', 'education_name' => 'ئالى تېخنىكوم'),
        array('education_id' => '8', 'education_name' => 'ئوتتۇرا تېخنىكوم'),
        array('education_id' => '9', 'education_name' => 'تولۇق ئوتتۇرا'),
        array('education_id' => '10', 'education_name' => 'تولۇقسىز'),
        array('education_id' => '11', 'education_name' => 'باشلانغۇچ'),
    );
    return $education;
}

//学历
function educationdata111() {
    $education = array(
        array('education_id' => '1', 'education_name' => 'مەدەنىيەت سەۋىيسى چەكلەنمەيدۇ'),
        array('education_id' => '2', 'education_name' => 'دوكتور ئاشتى'),
        array('education_id' => '3', 'education_name' => 'دوكتور'),
...
function areadata() {
    $area = array(
        array('area_id' => '1', 'area_name' => 'يۇرتى چەكلەنمەيدۇ'),
        array('area_id' => '2', 'area_name' => 'بىر يېزىلىق'),
        array('area_id' => '3', 'area_name' => 'بىر ناھىيەلىك'),
        array('area_id' => '4', 'area_name' => 'بىر شەھەرلىك'),
        array('area_id' => '5', 'area_name' => 'بىر ئۆلكىدىن'),
        array('area_id' => '6', 'area_name' => 'جۇڭگولۇق'),
        array('area_id' => '7', 'area_name' => 'يەر شارىلىق'),
    );
    return $area;
}
function areadata111() {
    $area = array(
        array('area_id' => '1', 'area_name' => 'يۇرتى چەكلەنمەيدۇ'),
        array('area_id' => '2', 'area_name' => 'بىر يېزىلىق'),
        array('area_id' => '3', 'area_name' => 'بىر ناھىيەلىك'),
...
function getgaptime($oldtime) {
    ...
    switch ($gaptime) {
        case $gaptime == 0:
            ...
            break;
        case $gaptime < 60:
            $restime = $gaptime . 'سىكۇنت بۇرۇن';
            break;
        case $gaptime < 60 * 60:
            $restime = floor($gaptime / 60) . 'مىنۇت بۇرۇن';
            break;
        case $gaptime < 60 * 60 * 24:
            $restime = floor($gaptime / (60 * 60)) . 'سائەت بۇرۇن';
            break;
        case $gaptime < 60 * 60 * 24 * 3;

            $restime = floor($gaptime / (60 * 60 * 24)) == 1 ? 'تۈنۈگۈن' . date('H:i', $oldtime) : 'ئۈلۈشكۈن' . date('H:i', $oldtime);
            break;
        case $gaptime < 60 * 60 * 24 * 30:
            $restime = floor($gaptime / (60 * 60 * 24)) . 'كۈن بۇرۇن';
            break;
        case $gaptime < 60 * 60 * 24 * 365:
            $restime = floor($gaptime / (60 * 60 * 24 * 30)) . 'ئاي بۇرۇن';
            break;
        case $gaptime < 60 * 60 * 24 * 365 * 3:
            $restime = floor($gaptime / (60 * 60 * 24 * 365)) . 'يىل بۇرۇن';
            break;
        default:
