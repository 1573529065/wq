<?php defined('IN_IA') or exit('Access Denied');?><div id="talk_list_style">
    ...
    <div class="talk_list_right">
        ...
        <a href="javascript:;<?php  //echo $this->createMobileUrl('talk_view',array('vid'=>$talk['talk_id']));?>">
            <div class="talk_list_right_1">{php echo $chat_num_replace != '' ?
                chat_num_replace($talk['talk_content'],$chat_num_replace) : $talk['talk_content'];}
            </div>
        </a>
        <!--说说内容结束-->
...
?>
        ...
        <div id="talk_list_right_2_<?php  echo $talk['talk_id'];?>" class="talk_list_right_2">
            ...
            <?php  if((!empty($talk['talk_pic1']))) { ?>
            <div class="talk_list_right_2_pic"><img src="<?php  echo $_W['attachurl'];?><?php  echo $talk['talk_pic1'];?>"/></div>
            <?php  } ?>
            <?php  if((!empty($talk['talk_pic2']))) { ?>
            <div class="talk_list_right_2_pic"><img src="<?php  echo $_W['attachurl'];?><?php  echo $talk['talk_pic2'];?>"/></div>
            <?php  } ?>
            <?php  if((!empty($talk['talk_pic3']))) { ?>
            <div class="talk_list_right_2_pic"><img src="<?php  echo $_W['attachurl'];?><?php  echo $talk['talk_pic3'];?>"/></div>
            <?php  } ?>
        </div>
        ...
        <a href="javascript:;"
           onclick="show_map('<?php  echo $this->createMobileUrl('weizhi',array('type'=>'talk','vid'=>$talk['talk_id']));?>');">
            <div class="talk_list_right_weizhi">
                <div class="talk_list_right_weizhi_left">
                    <div class="talk_list_right_weizhi_pic"><img src="<?php echo MODULE_URL;?>public/images/ditu1.png"/></div>
                </div>
        ...
        <div class="talk_list_right_3">
            ...
            <a href="<?php  echo $this->createMobileUrl('dashang',array('type'=>'2','talk_id'=>$talk['talk_id'],'receive'=>$talk['openid']));?>">
                <div class="talk_list_right_3_b">
                    <div class="talk_list_right_3_b_style">
                        <div class="talk_list_right_3_b_pic">
                            <div class="talk_list_right_3_b_pic_img"><img src="<?php echo MODULE_URL;?>public/images/dashang.png"/>
                            </div>
                        </div>
            ...
            <div onclick="dianzan('<?php  echo $talk['talk_id'];?>');" class="talk_list_right_3_b">
                <div class="talk_list_right_3_b_style">
                    <div class="talk_list_right_3_b_pic">
                        <div class="talk_list_right_3_b_pic_img"><img src="<?php echo MODULE_URL;?>public/images/zan.png"/></div>
                    </div>
                    <div class="talk_list_right_3_b_p">赞</div>
                    <div class="talk_list_right_3_b_n" id="talk_list_zan_<?php  echo $talk['talk_id'];?>">{php echo
                        gettalkzannum($_W['uniacid'],$talk['talk_id']);}
                    </div>
                </div>
            </div>
        ...
        <?php  if(($talk['openid']==$_W['openid'])&&($_GPC['do']=='talk_my')) { ?><a
            href="<?php  echo $this->createMobileUrl('talk_del',array('talk_id'=>$talk['talk_id']));?>">
        <div class="talk_list_del">
            <div class="talk_list_del_pic"><img src="<?php echo MODULE_URL;?>public/images/trash.png"/></div>
        </div>
    </a><?php  } ?>
...
<?php  if($user_pics) { ?>
<script>
    document.querySelector('#talk_list_right_2_{$talk['
    talk_id
    ']}'
    ).onclick = function () {
        wx.previewImage({
