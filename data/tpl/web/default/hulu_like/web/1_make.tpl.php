...
<div class="panel panel-default">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8">
      ...
      <input type="text" name="make_sj_bl" value="<?php  echo round($make['make_sj_bl']*100,4);?>" class="form-control" id="" placeholder="上级获得礼物佣金比例">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8">
	  <div class="input-group">
      <input type="text" name="make_tuiguang_bili" value="<?php  echo round($make['make_tuiguang_bili']*100,4);?>" class="form-control" id="" placeholder="分销商抽成比例">
      <div class="input-group-addon">%</div>
	  </div>
...
<!--表单结束-->
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8">
	  <div class="input-group">
      <input type="text" name="make_bili_gift" value="<?php  echo round($make['make_bili_gift']*100,4);?>" class="form-control" id="" placeholder="会员收到礼物所获佣金比例">
      <div class="input-group-addon">%</div>
	  </div>
...
<!--表单结束-->
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8">
	  <div class="input-group">
      <input type="text" name="make_bili_dashang" value="<?php  echo round($make['make_bili_dashang']*100,4);?>" class="form-control" id="" placeholder="会员收到打赏所获佣金比例">
      <div class="input-group-addon">%</div>
	  </div>
...
<!--表单结束-->
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8">
	  <div class="input-group">
      <input type="text" name="make_bili_liaotian" value="<?php  echo round($make['make_bili_liaotian']*100,4);?>" class="form-control" id="" placeholder="会员收到消息所获佣金比例">
      <div class="input-group-addon">%</div>
	  </div>
...
<!--表单结束-->
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8">
	  <div class="input-group">
      <input type="text" name="make_bili_zanshang" value="<?php  echo round($make['make_bili_zanshang']*100,4);?>" class="form-control" id="" placeholder="会员说说赞赏所获佣金比例">
      <div class="input-group-addon">%</div>
	  </div>
...
<!--表单开始-->
  <div class="form-group">
    ...
    <div class="col-sm-8">
	  <div class="input-group">
  <input type="text" name="make_active_proportion" value="<?php  echo round($make['make_active_proportion']*100,4);?>" class="form-control" id="" placeholder="活动定金支付比例">
      <div class="input-group-addon">%</div>
	  </div>
...
<div class="panel panel-default">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8">
	  <div class="input-group">
      <input type="text" name="make_tixian_money" value="<?php  echo $make['make_tixian_money'];?>" class="form-control" id="" placeholder="提现最低金额">
...
<!--表单开始-->
  <div class="form-group">
    ...
    <div class="col-sm-8">
	  <div class="input-group">
      <input type="text" name="make_tixian_time" value="<?php  echo $make['make_tixian_time'];?>" class="form-control" id="" placeholder="提现最短时间">
...
<div class="panel panel-default">
 ...
 <div class="form-group">
    ...
    <div class="col-sm-8">
      ...
      <input type="text" name="make_share_title" value="<?php  echo $make['make_share_title'];?>" class="form-control" id="" placeholder="分享标题">
...
<!--表单开始-->
 <div class="form-group">
    ...
    <div class="col-sm-8">
      ...
      <input type="text" name="make_share_content" value="<?php  echo $make['make_share_content'];?>" class="form-control" id="" placeholder="分享内容">
...
<!--表单开始-->
 <div class="form-group">
    ...
    <div class="col-sm-8">
      ...
      <input type="text" name="make_jinbi_name" value="<?php  echo $make['make_jinbi_name'];?>" class="form-control" id="" placeholder="货币名称">
...
<!--表单开始-->
 <div class="form-group">
    ...
    <div class="col-sm-8">
      ...
      <input type="text" name="make_jinbi_bili" value="<?php  echo $make['make_jinbi_bili'];?>" class="form-control" id="" placeholder="货币比例">
...
<!--表单开始-->
  <div class="form-group">
    ...
    <div class="col-sm-8">
	  <div class="input-group">
      <input type="text" name="make_liaotian_free" value="<?php  echo $make['make_liaotian_free'];?>" class="form-control" id="" placeholder="免费聊天数量">
...
<!--表单开始-->
  <div class="form-group">
    ...
    <div class="col-sm-8">
	  <div class="input-group">
      <input type="text" name="make_liaotian_jinbi" value="<?php  echo $make['make_liaotian_jinbi'];?>" class="form-control" id="" placeholder="免费聊天数量">
...
<!--表单开始-->
  <div class="form-group">
    ...
    <div class="col-sm-8">
	  <div class="input-group">
      <input type="text" name="make_liaotian_person" value="<?php  echo $make['make_liaotian_person'];?>" class="form-control" id="" placeholder="免费聊天数量">
...
<!--表单开始-->
  <div class="form-group">
    ...
    <div class="col-sm-8">
	  <div class="input-group">
      <input type="text" name="make_liaotian_time" value="<?php  echo $make['make_liaotian_time'];?>" class="form-control" id="" placeholder="免费聊天数量">
      <div class="input-group-addon">天</div>
	  </div>
	  <span class="help-block">日后扩展用</span>
    </div>
...
<!--表单结束-->
  <div class="form-group">
    ...
    <div class="col-sm-8">
	  <div class="input-group">
            <input type="text" name="chat_num_replace" value="<?php  echo $make['chat_num_replace'];?>" class="form-control" id="chat_num_replace">
...
<!--表单开始-->
 <div class="form-group">
    ...
    <div class="col-sm-8">
      ...
      <input type="text" name="make_web_title" value="<?php  echo $make['make_web_title'];?>" class="form-control" id="" placeholder="网站标题">
...
<!--表单开始-->
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8">
	  <div class="input-group">
      <input type="text" name="make_vip_year" value="<?php  echo $make['make_vip_year'];?>" class="form-control" id="" placeholder="年VIP价格">
      <div class="input-group-addon">元</div>
	  </div>
...
<!--表单结束-->
 ...
 <div class="form-group">
    ...
    <div class="col-sm-8">
		  <div class="input-group">
      <input type="text" name="make_vip_quarter" value="<?php  echo $make['make_vip_quarter'];?>" class="form-control" id="" placeholder="季度VIP价格">
	        <div class="input-group-addon">元</div>
	  </div>
 ...
 <div class="form-group">
    ...
    <div class="col-sm-8">
		  <div class="input-group">
      <input type="text" name="make_vip_month" value="<?php  echo $make['make_vip_month'];?>" class="form-control" id="" placeholder="月VIP价格">
	        <div class="input-group-addon">元</div>
	  </div>
 ...
 <div class="form-group">
    ...
    <div class="col-sm-8">
		 <div class="input-group">
 <input type="number" name="make_vip_contact" value="<?php  echo $make['make_vip_contact'];?>" class="form-control" id="" placeholder="VIP每天可查看联系方式数量">
	  <div class="input-group-addon">个</div>
	   </div>
...
<!--表单结束-->
 ...
 <div class="form-group">
    ...
    <div class="col-sm-8">
      ...
      <input type="text" name="make_key" value="<?php  echo $make['make_key'];?>" class="form-control" id="" placeholder="腾讯云短信APPID">
 ...
 <div class="form-group">
    ...
    <div class="col-sm-8">
      ...
      <input type="text" name="make_secret" value="<?php  echo $make['make_secret'];?>" class="form-control" id="" placeholder="腾讯云短信APPKEY">
 ...
 <div class="form-group">
    ...
    <div class="col-sm-8">
      ...
      <input type="text" name="make_sign" value="<?php  echo $make['make_sign'];?>" class="form-control" id="" placeholder="腾讯云短信签名">
 ...
 <div class="form-group">
    ...
    <div class="col-sm-8">
      ...
      <input type="text" name="make_msgtemplate" value="<?php  echo $make['make_msgtemplate'];?>" class="form-control" id="" placeholder="腾讯云短信模板ID">
 ...
 <div class="form-group">
    ...
    <div class="col-sm-8">
      ...
      <input type="text" name="make_key_baidu" value="<?php  echo $make['make_key_baidu'];?>" class="form-control" id="" placeholder="请输入百度地图KEY">
 ...
 <div class="form-group">
    ...
    <div class="col-sm-8">
      ...
      <input type="text" name="make_key_qq" value="<?php  echo $make['make_key_qq'];?>" class="form-control" id="" placeholder="请输入腾讯地图KEY">
