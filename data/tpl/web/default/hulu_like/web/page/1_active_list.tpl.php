<?php defined('IN_IA') or exit('Access Denied');?><tr>
    ...
    <td><img style="width:60px;height:60px;border-radius:50%;"
             src="<?php  echo getavatar($_W['uniacid'],$active['openid']);?>"/></td>

    <td>
        <?php  echo getactivetype($active['active_type']);?><br/>
        <?php  echo $active['active_title'];?><br/>
        <?php  echo $active['active_address'];?>
    </td>
    ...
    <td><span class='label label-success'><?php  echo round($active['active_money'],2);?></span><br/><?php  echo $active['active_content'];?>
    </td>
    ...
    <td>
        <a class="btn btn-default"
           href="<?php  echo $this->createWebUrl('active_update',array('active_id'=>$active['active_id'],'active_pid'=>'3'));?>"
           role="button">
            <i class="fa fa-check fa-fw"></i>
        </a>

        <a class="btn btn-default"
           href="<?php  echo $this->createWebUrl('active_update',array('active_id'=>$active['active_id'],'active_pid'=>'1'));?>"
           role="button">
